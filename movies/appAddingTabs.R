...
ui <- fluidPage(
  ...
  # SELECT A BALLER THEME, use to toggle between themes
  # themeSelector(),
  
  # ONCE YOU FIGURE OUT THEME, comment out themeSelector above
  theme = shinytheme("superhero"),
  
  # Application title -----------------------------------------------
  titlePanel("Elliott's big head (that's what she said)"),
  ...
  # Output: -------------------------------------------------------
    mainPanel(
      ...
      tabsetPanel(type = "tabs",
                  ...
                  #                 tags$a("Rotten Tomatoes", href = "https://
                  #                        www.rottentomatoes.com/"), "."),
                  #                 tags$p("The data represent", nrow(movies), "randomly sampled
                  #                 movies released between 1972 to 2014 in the United States.")))
